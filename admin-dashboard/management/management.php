...
<body style="background-image: url('../../images/steel_coils.jpg'); background-size: cover;">
    ...
    <div class ="flex flex-col justify-content: center  py-10 px-0 "  >
        <button style="width:600px; padding:20px ; font-size: 20px; margin-top: 10px;border:2px solid black ;"class = "bg-gray-400 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded max-w-md "onclick= "window.location.href='create_employee/create_employee.php'">Create New User</button>s
        ...
        <button style="width:600px; padding:20px ; font-size: 20px; margin-top: 10px;border:2px solid black ;" class = "bg-gray-400 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded max-w-md "onclick="window.location.href='../../super-admin/index.php'">Return to Dashboard</button>
