...
if (document.getElementById('parts_table').rows.length === 0) {
    var headers = ['Part Number', 'Volume', 'Width', 'Pitch', 'Gauge','Density','# Out','Line Produced on','Uptime','Parts Per Hour', 'Pcs Per Skid', 'Skids Per Truck','Weight Per Truck','Freight Per Piece', 'Blanking Per Piece Cost', 'Packaging Per Piece Cost', 'Total Per Piece'];
...
var cells = [ partNumber, volume, width, pitch, gauge, Density,numOutputs,lineProduced,uptime, partsPerHour,pcsPerSkid,skidsPerTruck,weightPerTruck,freightPerPiece ,blankingPerPieceCost,packagingPerPieceCost,totalPerPiece,];
