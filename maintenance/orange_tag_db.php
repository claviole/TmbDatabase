...
$query = "SELECT COUNT(*) as total FROM `orange_tag` WHERE `location_code` = '$current_user_location_code' AND `ticket_status` = 'Open' AND orange_tag_due_date BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 3 MONTH)";
$result = mysqli_query($database, $query);
$data = mysqli_fetch_assoc($result);
$openTicketCount = $data['total'];

// Query for priority 1 tickets
$query = "SELECT COUNT(*) as total FROM `orange_tag` WHERE `location_code` = '$current_user_location_code' AND `priority` = 1 AND `ticket_status` = 'Open' AND orange_tag_due_date BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 3 MONTH)";
$result = mysqli_query($database, $query);
$data = mysqli_fetch_assoc($result);
$priority1TicketCount = $data['total'];

// Query for priority 2 tickets
$query = "SELECT COUNT(*) as total FROM `orange_tag` WHERE `location_code` = '$current_user_location_code' AND `priority` = 2 AND `ticket_status` = 'Open' AND orange_tag_due_date BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 3 MONTH)";
$result = mysqli_query($database, $query);
$data = mysqli_fetch_assoc($result);
$priority2TicketCount = $data['total'];

// Query for priority 3 tickets
$query = "SELECT COUNT(*) as total FROM `orange_tag` WHERE `location_code` = '$current_user_location_code' AND `priority` = 3 AND `ticket_status` = 'Open' AND orange_tag_due_date BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 3 MONTH)";
$result = mysqli_query($database, $query);
$data = mysqli_fetch_assoc($result);
$priority3TicketCount = $data['total'];

// Query for priority 4 tickets
$query = "SELECT COUNT(*) as total FROM `orange_tag` WHERE `location_code` = '$current_user_location_code' AND `priority` = 4 AND `ticket_status` = 'Open' AND orange_tag_due_date BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 3 MONTH)";
$result = mysqli_query($database, $query);
$data = mysqli_fetch_assoc($result);
...
$query = "SELECT * FROM orange_tag WHERE location_code = '$current_user_location_code' AND orange_tag_due_date BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 3 MONTH)";
$result = mysqli_query($database, $query);
