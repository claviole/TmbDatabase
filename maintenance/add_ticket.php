...
$query = "INSERT INTO `orange_tag` (`orange_tag_id`, `ticket_type`, `originator`, `location`, `priority`,`line_name`, `section`, `supervisor`, `orange_tag_creation_date`, `orange_tag_creation_time`, `orange_tag_due_date`, `repairs_made`, `root_cause`, `equipment_down_time`, `total_repair_time`, `area_cleaned`, `follow_up_necessary`, `parts_needed`, `reviewed_by_supervisor`, `reviewed_by_safety_coordinator`, `supervisor_review_date`, `safety_coordinator_review_date`, `verified`, `date_verified`,`orange_tag_description`, `repair_technician`, `total_cost`, `ticket_status`, `work_order_number`) VALUES ('$orange_tag_id', '$ticket_type', '$originator', '$location', '$priority','$line_name', '$section', '$supervisor', '$orange_tag_creation_date', '$orange_tag_creation_time', '$orange_tag_due_date', '$repairs_made', '$root_cause', '$equipment_down_time', '$total_repair_time', '$area_cleaned', '$follow_up_necessary', '$parts_needed', '$reviewed_by_supervisor', '$reviewed_by_safety_coordinator', '$supervisor_review_date', '$safety_coordinator_review_date', '$verified', '$date_verified', '$orange_tag_description', '$repair_technician','$total_cost', '$ticket_status', '$work_order_number')";
