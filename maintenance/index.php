...
<div class="button-container">
    <button class="bg-gray-400 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded max-w-md" onclick="window.location.href='orange_tag_db.php'">
        <img src="../images/orange_tag.jpg" alt="HR">
    </button>
